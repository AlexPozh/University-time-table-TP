...
book = load_workbook("/home/alexander/Рабочий стол/Uni_time_table_IRIT/Bot_uni_time_table/bot/parsing_timetable/files_timetable/1_kurs_IRIT.xlsx")    # абсолютный путь до файла

ist_table = book["ист"]    # извлекаем отдельную таблицу для групп ИСТ


IST_GROUPS: dict[str, tuple[str, str, str]] = {   # словарь содержит координаты ячеек групп и их расписания
    "C10": ("A", "B", "C"),
    "E10": ("A", "B", "E"),
    "G10": ("A", "B", "G"),
    "I10": ("A", "B", "I"),
...
def parse_groups() -> dict[str, dict[str, list[str]]]:
